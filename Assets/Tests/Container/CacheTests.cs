...
namespace Tests.Container
{
    ...
    public class ContainerCacheTests
    {
        ...
        public void SetUp()
        {
            _cache = new Mock<ContainerCache>().Object;
        ...
        public void Add_WithNullArgument_2Arg_ThrowException()
        {
            ...
            Assert.Throws<ArgumentNullException>(
                () => _cache.Add(null, in _testObject), message: $"Type null");

            Assert.Throws<ArgumentNullException>(
                () => _cache.Add(_testObject.GetType(), null), message: $"Instance null");
        }
        ...
        {
            Assert.DoesNotThrow(
                () => _cache.Add<TestObject>(_testObject), message: $"Instance arg");

            Assert.DoesNotThrowAsync(
                () => _cache.Add(_emptyDict), message: $"Dictionary arg");

            Assert.DoesNotThrow(
                () => _cache.Add(typeof(TestObject), _testObject), message: $"Type and instance arg");
